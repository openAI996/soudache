local config = { 
	...
	[20] = { 
		...
		nbvalue="100#100#100",
		type=1,
		desc="影响角色攻击速度(关联M2-游戏参数-游戏速度-攻速减免时间) （暂时不同）",
		isshow=2,
		scolor=161,
		sort=6,
	},
