...
function ui.init(parent, __data__, __update__)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_main, "Button_close", 280, 271, "res/public/btn_gban_01.png")
	...
	-- Create Button_open
	local Button_open = GUI:Button_Create(Panel_main, "Button_open", 182, 84, "res/public/1900000662.png")
	GUI:Button_loadTexturePressed(Button_open, "res/public/1900000663.png")
	GUI:Button_loadTextureDisabled(Button_open, "Default/Button_Disable.png")
	GUI:Button_setScale9Slice(Button_open, 11, 11, 12, 12)
	...
	GUI:Button_setTitleColor(Button_open, "#00ff00")
